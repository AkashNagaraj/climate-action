...
## Obtain the historical air pollution data for a specifc city
...
# Pass a list of cities to this function and combine their air pollution data to a pandas dataframe
...
# This is used to convert the time-stamp based on a monthly basis and sort 
...
def main():
    city_list = read_data()
    count = 40 # Passing only 40 cities
