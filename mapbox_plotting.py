...
def plot_temp_data():
    ...
    hover_name="city",
    mapbox_style='navigation', zoom=1
    )
...
def plot_air_quality_data():
    ...
    fig = px.scatter_mapbox(data, lat="Lat", lon="Long", size="co", size_max=15, color="co", color_continuous_scale=px.colors.sequential.Pinkyl, hover_name="city", mapbox_style='dark', zoom=1)
    fig.layout.coloraxis.showscale = False
    fig.show()
